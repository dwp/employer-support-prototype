...
router.post('/prototype-A/com-q2-shortcut-routing', function (req, res) {

    let comQ2shortcut = req.session.data.comQ2shortcut;

    if (comQ2shortcut == 'yes'){
        res.redirect('com-q4');
    } else if (comQ2shortcut == 'no'){
        res.redirect('com-g2');
    }   
});
...
router.post('/prototype-A/com-q5-checklist-routing', function (req, res) {
    ...
    if (comQ4 == 'waysOfWorking'){
        res.redirect('rea-c1');
    } else if (comQ4 == 'waysOfWorking' && 'workEnvironment' && 'extrasupport'){
        res.redirect('rea-c1');
    } else if (comQ4 == 'waysOfWorking' && comQ4 == 'workEnvironment' && comQ4 == 'extraSupport'){
        res.redirect('rea-c1');
    } else if (comQ4 == 'workEnvironment' ){
        res.redirect('rea-c2');
    } else if (comQ4 == 'extraSupport'){
        res.redirect('rea-c3');
    } else {
        res.redirect('adj-q2');
    }    
...
router.post('/prototype-A/com-q4-routing', function (req, res) {
    ...
    if (comQ4 == 'yes'){
        res.redirect('com-q5');
    } else if (comQ2 == 'yes' && comQ4 == 'no'){
        res.redirect('adj-q2');
    }  else if (comQ2 == 'no' && comQ4 == 'no'){
        res.redirect('adj-q2');
    }  else if (comQ2shortcut == 'yes' && comQ4 == 'no'){
        res.redirect('sta-4');
    }  else if (comQ2shortcut == 'no' && comQ4 == 'no'){
        res.redirect('sta-4');
    }   
});
*/
...
router.post('/prototype-B/com-q4-routing', function (req, res) {
...
router.post('/prototype-B/com-q5-checklist-routing', function (req, res) {
...
router.post('/shortcuts-A/ssp-routing', function (req, res) {
...
router.post('/shortcuts-A/com-q2-routing', function (req, res) {
...
router.post('/shortcuts-A/com-q5-checklist-routing', function (req, res) {
...
router.post('/shortcuts-B/sta-q2-routing', function (req, res) {
    let staQ2 = req.session.data.staQ2;
...
router.post('/shortcuts-B/ssp-routing', function (req, res) {
...
router.post('/shortcuts-B/com-q2-routing', function (req, res) {
...
router.post('/shortcuts-B/com-q5-checklist-routing', function (req, res) {
