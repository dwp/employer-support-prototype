...
router.post('/prototype-A/sta-q3-routing', function (req, res) {
    let staQ3 = req.session.data.staQ3;

    if (staQ3 == 'atWork'){
        res.redirect('est-q3');
    } else if (staQ3 == 'offWork') {
        res.redirect('est-q1');
    } else if (staQ3 == 'policesProcedures') {
        res.redirect('pol-g1');
    } else {
        res.redirect('iro-g1');
    }   
...
router.post('/prototype-A/est-q3-routing', function (req, res) {
    ...
    if (staQ3 == 'atWork' && estQ3 == 'notToldMe') {
        res.redirect('est-g6');
    } else if (staQ3 == 'offWork' && estQ3 == 'notToldMe') {
        res.redirect('est-g5');
    } else if (staQ3 == 'atWork' && estQ3 == 'notAsked') {
        res.redirect('com-g9');
    } else if (staQ3 == 'offWork' && estQ3 == 'notAsked') {
        res.redirect('com-g8');
    } else {
        res.redirect('est-g4');
    }   
...
router.post('/prototype-A/adj-q2-routing', function (req, res) {
    ...
    if (adjQ2 == 'no'){
        ...
        res.redirect('com-g6');
    } else if (staQ3 == 'offWork' && adjQ2 == 'yes'){
        res.redirect('ret-g7');
    } else {
...
router.post('/prototype-A/adj-q4-routing', function (req, res) {
    ...
    if (staQ3 == 'offWork' && adjQ2 == 'no' && adjQ4 == 'no') {
        res.redirect('dis-g2');
    } else if (staQ3 == 'atWork' && adjQ2 == 'no' && adjQ4 == 'no') {
        res.redirect('dis-g1');
    } else {
        res.redirect('adj-g5');
    }   
...
router.post('/prototype-A/adj-g5-routing', function (req, res) {
    ...
    if (estQ6 == 'yes'){
        ...
        res.redirect('adj-g10');
    } else if (staQ3 == 'offWork' && adjQ2 == 'no'){
        res.redirect('dis-g2');
    } else if (staQ3 == 'atWork' && adjQ2 == 'no'){
        res.redirect('dis-g1');
    } else {
        res.redirect('adj-g10');
    }    
...
router.post('/prototype-B/sta-q3-routing', function (req, res) {
    let staQ3 = req.session.data.staQ3;
