...
router.post('/prototype-A/skip-3-routing', function (req, res) {
    ...
    if (staQ2 == 'noOffWork' && skip3 == 'NoTakeMeToSummary'){
        res.redirect('sum-6');
    } else if (staQ2 == 'yesWorking' && skip3 == 'NoTakeMeToSummary'){
        res.redirect('sum-5'); 
    } else {
        res.redirect('adj-g5');
    }    
...
router.post('/prototype-A/skip-2-routing', function (req, res) {
    ...
    if (staQ2 == 'noOffWork' && skip2 == 'yes'){
        res.redirect('ret-g7');
    } else if (staQ2 == 'yesWorking' && skip2 == 'yes'){
        res.redirect('adj-g10'); 
    } else {
